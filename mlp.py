...
train_data = train_data.shuffle(200) # if you want to shuffle your data
train_data = train_data.batch(batch_size)

# create testing Dataset and batch it
test_data = tf.data.Dataset.from_tensor_slices(test)
test_data = test_data.shuffle(120)
...
w = tf.get_variable("w", shape=(3136,L), initializer=tf.random_normal_initializer(0,0.01))
...
w5 = tf.get_variable("w5", shape=(O,40), initializer=tf.random_normal_initializer(0,0.01))
